...
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = ''
# For multi-modal models: separate pretrained weights for optical and SAR branches
_C.MODEL.OPTICAL_PRETRAINED = ''
_C.MODEL.SAR_PRETRAINED = ''
...
# Multi-modal model flag
_C.MODEL.MULTIMODAL = False
# Fusion module parameters for multi-modal models
_C.MODEL.FUSION_NUM_HEADS = 8
_C.MODEL.FUSION_DROPOUT = 0.1
# Frequency domain fusion (enables DWT-based fusion)
_C.MODEL.USE_FREQUENCY_FUSION = True
# Boundary enhancement (enables boundary-aware modules)
_C.MODEL.USE_BOUNDARY_ENHANCEMENT = True
# Detail enhancement (enables detail enhancement modules for better fine-grained detail preservation)
_C.MODEL.USE_DETAIL_ENHANCEMENT = True
...
_C.MODEL.USE_STAGE_FUSION = False
# Loss function type: 'balanced_ce', 'combined', 'combined_focal', 'combined_edge'
_C.MODEL.LOSS_TYPE = 'combined'
# Loss weights for combined loss
_C.MODEL.LOSS_CE_WEIGHT = 0.5
_C.MODEL.LOSS_DICE_WEIGHT = 0.5
_C.MODEL.LOSS_FOCAL_WEIGHT = 0.2
_C.MODEL.LOSS_EDGE_WEIGHT = 0.05
...
_C.TRAIN.EARLY_STOP_PATIENCE = 30  # Stop training if no improvement for N epochs
_C.TRAIN.EARLY_STOP_MIN_DELTA = 0.001  # Minimum improvement threshold
# Checkpoint saving configuration
_C.TRAIN.SAVE_FREQ = 10  # Save checkpoint every N epochs
_C.TRAIN.KEEP_LAST_N_CHECKPOINTS = 5  # Keep last N checkpoints
